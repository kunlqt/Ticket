...
public class ArchievedTicketListAdapter extends ArrayAdapter<ModelCorrectionTicket> implements
		OnClickListener {
	private List<ModelCorrectionTicket> list;
	private Context conActivity;
	ViewHolder viewHolder;

	public ArchievedTicketListAdapter(Context conActivity, List<ModelCorrectionTicket> list) {
